...
(function($) {
    ...
    win.on('scroll', function() {
       ...
       if (scroll < 1) {
        ...
        var elementTop = $(this).offset().top - $('#ga-header').outerHeight();
   ...
   //Testimonials Slider
    ...
    $('.course-view-part .view-icons .view-grid').on('click',function(e){
        e.preventDefault();
        $('.ga-popular-courses').removeClass('list-view');
    });
    $('.course-view-part .view-icons .view-list').on('click',function(e){
        e.preventDefault();
        $('.ga-popular-courses').addClass('list-view');
    });
